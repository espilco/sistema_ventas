...
// Verificación de permisos con PDO
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        if (empty($id)) {
            ...
            $query = $conexion->prepare("SELECT * FROM cliente WHERE nombre = :nombre");
            ...
            if ($result) {
                ...
                // Insertar cliente
                $query_insert = $conexion->prepare("INSERT INTO cliente(nombre, telefono, direccion) VALUES (:nombre, :telefono, :direccion)");
            ...
            // Actualizar cliente
            $sql_update = $conexion->prepare("UPDATE cliente SET nombre = :nombre, telefono = :telefono, direccion = :direccion WHERE idcliente = :id");
            $update_result = $sql_update->execute([
                ':nombre' => $nombre, 
                ':telefono' => $telefono, 
                ':direccion' => $direccion,
                ':id' => $id
